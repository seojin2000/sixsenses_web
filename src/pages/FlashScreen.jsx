      ...
      <div className="p-6">
        ...
        <div className="space-y-6 mb-8">
          <div className="flex items-center space-x-4 bg-blue-50 p-4 rounded-lg">
            ...
            <div>
              <h3 className="font-semibold text-slate-800">10개의 한자성어</h3>
              <p className="text-sm text-slate-600">다양한 한자성어를 학습할 수 있습니다</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4 bg-yellow-50 p-4 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">다른 사용자들과 점수를 비교해보세요</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4 bg-green-50 p-4 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">한자 실력을 재미있게 향상시킬 수 있습니다</p>
            </div>
          </div>
        </div>
        ...
        {/* 시작 버튼 */}
        <div className="mt-8">
          <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-6 text-lg rounded-lg shadow-lg hover:shadow-xl transition-all">
            퀴즈 시작하기
          </button>
        </div>
      </div>
